...
public class TCPListener extends Thread{
    ...
    public void run(){
        ...
        try{
            ...
            while(!fin){
                ...
                System.out.println("[SOL] Se ha registrado la conexion "+id);
    ...
    protected void registerConnection(String id,SenderConnection c){   
        /*System.out.println("[SOL] Se ha registrado la conexion con el id: "+id);
    ...
    protected void unregisterConnection(String id){
        /*System.out.println("[SOL] La conexion "+id+" se ha eliminado de la plataforma.");
