    ...
    public void run() {
        ...
        try {
            ...
            while (!end) {
                 ...
                 * acabe de recibir el ultimo mensaje desde el agente se cerrara
                 * la conexion con ese agente y se volvera a esperar a uno
                 * nuevo.
                 */
                /*
                ...
                //Código necesario para la recepción de mensajes proveniente de SensorAgent que utilizan MeshliumCoordinator
                ...
                if (input != null && input != "") { //&& !input.contains("HELLO")){
                    ...
                    if (msg.getOntology().equals("REG_ONTOLOGY")) {
                        ...
                        if (msg.getProtocol().equals("RegisterAgent")) {
                            ...
                            // Se envia la confirmacion al agente
                            ...
                            // Se envia el mensaje de replica.
                            AuroraMessage reply = msg.createReply();
                        ...
                        // Se envia el mensaje al destinatario.
                        ...
                        //System.out.println("El tiempo desde que llega a TCP connection hasta que envia es: "+result);
                        //reader = new BufferedReader( new InputStreamReader ( server.getInputStream() ) );
                    }
                } else {
                    end = true;
